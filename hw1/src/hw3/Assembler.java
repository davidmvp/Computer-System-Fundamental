...
public class Assembler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        allOp = as.returnOp();
        File inputFile = new File("loop.txt");
        	...
        	for (int i = 0; i < arr.size() ; i++) {
                ...
                String addre = Integer.toBinaryString(address) + "";
                 while (addre.length() < 4) {
                  ...
                  int inte1 = Integer.parseInt(addre);
                  long lon = (long) inte;
                  long lon1 = (long) inte1;
                  long result = (long)lon | lon1 << 4;
                  System.out.write((byte)result & 0xFF);
